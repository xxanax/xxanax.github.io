document.addEventListener('DOMContentLoaded', () => {
    ...
    const commands = [
        ...
        { text: '1. FinanceKrythBot - минималистичное веб-приложение для менеджмента финансов', delay: 50, class: 'info' },
        { text: 'Стек: Python, Chart Js, Flask, socketio, Nginx, Supervisor, Gunicorn, PostgreSQL', delay: 50, class: 'var' },
        { text: 'Ссылка: https://t.me/FinanceKrythBot', delay: 50, class: 'link', href: 'https://t.me/FinanceKrythBot' },
        { text: ' ', delay: 50 },
        
        { text: '2. KrythToDoBot - Telegram бот с минималистичным таск трекером в стиле терминала внутри', delay: 50, class: 'info' },
        ...
        { text: '3. KrythNoteBot - Telegram бот с веб-приложением для заметок', delay: 50, class: 'info' },
        { text: 'Стек: Python, Flask, socketio, Nginx, Supervisor, Gunicorn, PostgreSQL', delay: 50, class: 'var' },
        { text: 'Ссылка: https://t.me/krythnotebot', delay: 50, class: 'link', href: 'https://t.me/krythnotebot' },
        { text: ' ', delay: 50 },
        
        { text: '4. RedRockRobot - Telegram бот с мультиплеерной игрой в крестики-нолики', delay: 50, class: 'info' },
        { text: 'Стек: Python, Flask, socketio, Nginx, Supervisor, Gunicorn, PostgreSQL', delay: 50, class: 'var' },
